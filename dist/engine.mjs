...
export class Engine {
  ...
  applyEffects(e,c,targets,t){
    ...
    if(e.DrawCards)this.draw(o,e.DrawCards);if(e.DrawIfAllyCategoryInPlay&&this.list(o,'field').some(x=>overlaps(this.rule(x).cardCategories,e.DrawIfAllyCategoryInPlay)))this.draw(o,1);if(e.DrawTo)this.draw(o,Math.max(0,e.DrawTo-this.list(o,'hand').length));
